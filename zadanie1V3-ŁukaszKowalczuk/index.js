...
if (QueryString === ""){
    ...
    ServerUsername=UrlParams.get("ServerUsername")
    const ServerPass=UrlParams.get("ServerPass")

    localStorage.setItem("ServerCmd",ServerCmd)
    localStorage.setItem("ServerScreen",ServerScreen)
...
function OnLoad(){
    const ServerCmd=Number(localStorage.getItem("ServerCmd"))
    const ServerScreen=Number(localStorage.getItem("ServerScreen"))
    ServerUsername=localStorage.getItem("loggedUser")
    ...
    localStorage.removeItem("ServerCmd")
    localStorage.removeItem("ServerScreen")
